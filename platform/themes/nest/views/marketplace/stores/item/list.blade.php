    ...
    <div class="vendor-wrap style-2 mb-40">
        <div class="vendor-img-action-wrap">
            <div class="vendor-img">
                <a href="{{ $store->url }}">
                    <img class="default-img" src="{{ RvMedia::getImageUrl($store->logo, 'medium', false, RvMedia::getDefaultImage()) }}" alt="{!! BaseHelper::clean($store->name) !!}" />
                </a>
            </div>
            <div class="mt-10">
        ...
        <div class="vendor-content-wrap">
            <div class="mb-30">
                ...
                <h4 class="mb-5"><a href="{{ $store->url }}">{!! BaseHelper::clean($store->name) !!}</a></h4>
